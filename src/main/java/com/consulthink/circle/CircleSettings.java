package com.consulthink.circle;
...
public class CircleSettings extends AbstractSettings {
	...
	public static final Setting MQTT_BROKER = new Setting(
			...
			"User Wallet File",
			"Description", 
			"tcp://10.10.50.30:1883", new NotEmpty());
	...
	public CircleSettings() throws SettingValidationException, UnknownSettingException {
		super();
	}
	
	public CircleSettings(Properties properties) throws SettingValidationException, UnknownSettingException {
		super(properties);
	}
	
	public CircleSettings(Properties properties, Set<Setting> excludedSettings) throws SettingValidationException, UnknownSettingException {
